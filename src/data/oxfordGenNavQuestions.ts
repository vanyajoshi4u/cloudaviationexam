...
const ch14Questions: MCQuestion[] = [
  ...
  { id: 2, question: "The great circle bearing of B (30°00'S) from A (30°00'S 165°00'E) is 100°(T). What is the great circle track from B to A?", options: ["280°(T)", "260°(T)", "270°(T)", "250°(T)"], correct: 1 },
  { id: 3, question: "The rhumb line from D (30°00'N 179°00'W) to C is 090°(T). The great circle initial track from C to D is 287°(T). What is the great circle track from D to C?", options: ["083°(T)", "073°(T)", "063°(T)", "093°(T)"], correct: 1 },
  { id: 4, question: "The great circle track from A to B measures 227°(T) at A and 225°(T) at B. What is the convergency and in which hemisphere?", options: ["2°, Northern Hemisphere", "2°, Southern Hemisphere", "4°, Northern Hemisphere", "4°, Southern Hemisphere"], correct: 0 },
  { id: 5, question: "In what latitude is the convergency between two meridians equal to twice their convergency in latitude 20°N?", options: ["40°N", "43°N", "45°N", "50°N"], correct: 1 },
  { id: 6, question: "A and B are in the same hemisphere. The initial GC track from B to A is 268°(T) and from A to B is 092°(T). In which hemisphere are A and B, and what is the rhumb line track from A to B?", options: ["Southern, 090°(T)", "Northern, 090°(T)", "Southern, 092°(T)", "Northern, 088°(T)"], correct: 0 },
  { id: 7, question: "Position X 64°00'S 11°50'W, Position Y 64°00'S 05°10'W. What is the convergency between the meridians of X and Y?", options: ["4°", "6°", "8°", "10°"], correct: 1 },
  { id: 8, question: "Calculate the convergency between A (55°30'N 04°35'W) and B (64°00'N 22°37'W). If the rhumb line track from A to B is 313°(T), what is the approximate initial GC track from B to A?", options: ["117°(T)", "125°(T)", "133°(T)", "141°(T)"], correct: 1 },
  { id: 9, question: "The initial GC track from B to A is 245°(T) and the rhumb line track from A to B is 060°(T). Mean latitude is 53°, longitude of B is 02°15'E. What is the longitude of A?", options: ["005°15'W", "010°15'W", "015°15'W", "007°30'W"], correct: 1 },
  { id: 10, question: "A and B are in the southern hemisphere, convergency is 8°. Initial GC track from A to B is 094°(T). B is at 23°00'S 20°00'W. What is the position of A?", options: ["23°00'S 030°30'W", "23°00'S 040°30'W", "23°00'S 028°00'W", "23°00'S 035°00'W"], correct: 1 },
];
